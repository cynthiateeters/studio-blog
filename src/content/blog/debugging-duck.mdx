...
<figure>
  <img src="https://res.cloudinary.com/cynthia-teeters/image/upload/f_auto,q_auto,w_480,c_limit/canvas/hap/hap-thinking-w-duck" alt="HAP robot thinking pensively while holding rubber duck, finger on chin" style="max-width: 480px; border-radius: 5%;" loading="lazy" />
  <figcaption>The duck doesn't judge. The duck just listens.</figcaption>
</figure>
