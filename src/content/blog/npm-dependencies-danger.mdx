...
<figure>
  <img src="https://res.cloudinary.com/cynthia-teeters/image/upload/f_auto,q_auto,w_480,c_limit/canvas/hap/hap-sad-falling-papers" alt="HAP robot looking sad holding papers with more scattered on floor" style="max-width: 480px; border-radius: 5%;" loading="lazy" />
  <figcaption>When dependencies go wrong, everything falls apart.</figcaption>
</figure>
