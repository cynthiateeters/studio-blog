...
<figure>
  <img src="https://res.cloudinary.com/cynthia-teeters/image/upload/f_auto,q_auto,w_480,c_limit/canvas/hap/hap-pointing-up" alt="HAP robot pointing upward with one finger, smiling encouragingly" style="max-width: 480px; border-radius: 5%;" loading="lazy" />
  <figcaption>Simple tools win — HAP approves of Markdown.</figcaption>
</figure>
