...
<figure>
  <img src="https://res.cloudinary.com/cynthia-teeters/image/upload/f_auto,q_auto,w_480,c_limit/canvas/hap/hap-holding-mystical-orb" alt="HAP robot cradling a glowing mystical orb in both hands" style="max-width: 480px; border-radius: 5%;" loading="lazy" />
  <figcaption>Some things are too precious to share publicly — like API keys.</figcaption>
</figure>
