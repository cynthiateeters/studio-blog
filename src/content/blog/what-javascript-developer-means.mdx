...
<ResponsiveFigure
  src="canvas/hap/hap-holding-js-coin"
  alt="HAP robot proudly holding large glowing JavaScript logo coin"
  caption="HAP proudly holds a glowing JavaScript coin — every developer's first treasure."
/>
